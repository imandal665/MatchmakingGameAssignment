...
import com.example.matchmakinggameassignment.dailogs.GameMenuDialog;
    ...
    private void setingUpAllListners() {
        ...
        cardMatch1.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                return InGameActivity.this.onTouch(event, cardMatch1);
            }
        });
        ...
        cardMatch2.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                return InGameActivity.this.onTouch(event, cardMatch2);
            }
        });
...
//                y_cord = (int) event.getY();
    ...
    private void playTaskAchievedSoundEffect() {
        MediaPlayer mp = MediaPlayer.create(this, R.raw.comleted);
        mp.start();
    }
